...
export default {
  ...
  data() {
    return {
      // 城市数据
      cityData: [
        {name: "北京", value: 458.09},
        {name: "天津", value: 309.09},
        {name: "上海", value: 405.04},
        {name: "重庆", value: 352.62},
        {name: "河北", value: 841.63},
        {name: "河南", value: 985.33},
        {name: "云南", value: 277.1},
        {name: "辽宁", value: 559.72},
        {name: "黑龙江", value: 428.63},
        {name: "湖南", value: 512.64},
        {name: "安徽", value: 638.31},
        {name: "山东", value: 861.4},
        {name: "新疆", value: 280.25},
        {name: "江苏", value: 896.7},
        {name: "浙江", value: 758.3},
        {name: "江西", value: 285.76},
        {name: "湖北", value: 488.32},
        {name: "广西", value: 232.42},
        {name: "甘肃", value: 154.13},
        {name: "山西", value: 400.09},
        {name: "内蒙古", value: 210.17},
        {name: "陕西", value: 309.08},
        {name: "吉林", value: 310.07},
        {name: "福建", value: 402.35},
        {name: "贵州", value: 169.86},
        {name: "广东", value: 861.76},
        {name: "青海", value: 38.68},
        {name: "西藏", value: 7.07},
        {name: "四川", value: 813.16},
        {name: "宁夏", value: 48.93},
        {name: "海南", value: 63.28},
        {name: "台湾", value: 123},
        {name: "香港", value: 32},
...
drawMap(cityData) {
  ...
  let option = {
    ...
    tooltip: {
      ...
      formatter: function (params) {
        return params.name + '<br/>' + '糖尿病患者数：' + params.value;
      }
    },
    legend: {
      show: false
    ...
    visualMap: {
      ...
      calculable: true,
      inRange: {
        color: ['#FFCCCB', '#FF6347'], // Lighter shades of red
        symbolSize: [100, 100]
      },
      outOfRange: {
        color: ['#FFCCCB'],
    ...
    series: [
      {
        ...
        itemStyle: {
          normal: {
            areaColor: '#FFCCCB', // Lighter shade of red
            borderColor: '#89A4DB',
            borderWidth: 1.5
          },
          emphasis: {
            areaColor: '#FFE4E1', // Lighter shade of pink
            borderWidth: 1.5
          }
        },
        data: cityData
        ...
        itemStyle: {
          normal: {
            color: new echarts.graphic.LinearGradient(0, 0, 1, 0, [{
              offset: 0,
              color: '#F08080' // Lighter shade of red
            }, {
              offset: 1,
              color: '#CD5C5C' // Darker shade of red
            }])
          }
        },
      }
  ...
  myEcharts.on('click', function (params) {
    // Handle the click event for a specific province
  ...
  window.addEventListener("resize", function () {
    ...
    drawProbaBar(probaData) {
      ...
      const colors = ["#faa755","#585eaa", "#50b7c1", "#faa755"];
      // 指定配置和数据
      let option = {
        color: colors,
        tooltip: {
